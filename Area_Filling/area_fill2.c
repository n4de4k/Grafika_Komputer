    ...
    switch (c) {
        ...
        break;
				...
				case 'U' : {
					...
					floodFill(dotU[0]+pos,dotU[1],&old,&new);
				}
				break;
				...
				case 'V' : {
					...
					floodFill(dotV[0]+pos,dotV[1],&old,&new);
				}
				break;
				...
				case 'W' : {
					...
					floodFill(dotW[0]+pos,dotW[1],&old,&new);
				}
				break;
				...
				case 'X' : {
					...
					floodFill(dotX[0]+pos,dotX[1],&old,&new);
				}
				break;
        ...
        case 'J' : {
            ...
            floodFill(dotJ[0]+pos,dotJ[1],&old,&new);
        };
        break;
        ...
        case 'K' : {
            ...
            floodFill(dotK[0]+pos,dotK[1],&old,&new);
        };
        break;
        ...
        case 'L' : {
            ...
            floodFill(dotL[0]+pos,dotL[1],&old,&new);
        };
        break;
        ...
        case 'M' : {
            ...
            floodFill(dotM[0]+pos,dotM[1],&old,&new);
        };
        break;
        ...
        case 'N' : {
            ...
            floodFill(dotN[0]+pos,dotN[1],&old,&new);
        };
        break;
        ...
        case 'O' : {
            ...
            floodFill(dotO[0]+pos,dotO[1],&old,&new);
        };
        break;
        ...
        case 'P' : {
            ...
            floodFill(dotP[0]+pos,dotP[1],&old,&new);
        };
        break;
        ...
        case 'Q' : {
            ...
            floodFill(dotQ[0]+pos,dotQ[1],&old,&new);
        };
        break;
        ...
        case 'R' : {
            ...
            floodFill(dotR[0]+pos,dotR[1],&old,&new);
        };
        break;
        ...
        case 'S' : {
            ...
            floodFill(dotS[0]+pos,dotS[1],&old,&new);
        };
        break;
